...
public class FirebaseHelper {
    ...
    public static void putUser(String name, FirebaseUser user) {
        if (user == null) return;
        ...
        db.collection(COLLECTION_USERS).document(user.getUid())
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "User info successfully uploaded");
                    } else {
                        Log.w(TAG, "Error uploading User info");
                    }
                });
    }
    ...
    public static void putSpending(Spending spending, FirebaseUser user) {
        ...
        db.collection(COLLECTION_USERS).document(user.getUid())
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "Spending successfully uploaded");
                    } else {
                        Log.w(TAG, "Error uploading Spending");
                    }
                });
    }
    ...
    public static void putDebtLend(DebtLend debtLend, FirebaseUser user) {
        ...
        db.collection(COLLECTION_USERS).document(user.getUid())
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "DebtLend successfully uploaded");
                    } else {
                        Log.w(TAG, "Error uploading DebtLend");
                    }
                });
    }
    ...
    public static void putSpendGoal(SpendGoal spendGoal, FirebaseUser user) {
        ...
        db.collection(COLLECTION_USERS).document(user.getUid())
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "SpendGoal successfully uploaded");
                    } else {
                        Log.w(TAG, "Error uploading SpendGoal");
                    }
                });
    }
    ...
    public static void putWallet(Wallet wallet, FirebaseUser user) {
        ...
        db.collection(COLLECTION_USERS).document(user.getUid())
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "Wallet successfully uploaded");
                    } else {
                        Log.w(TAG, "Error uploading Wallet");
                    }
                });
    }
    ...
    public static void putRelate(Relate relate, FirebaseUser user) {
        ...
        db.collection(COLLECTION_USERS).document(user.getUid())
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "Relate successfully uploaded");
                    } else {
                        Log.w(TAG, "Error uploading Relate");
                    }
                });
    }
}
